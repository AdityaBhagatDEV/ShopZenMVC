...
namespace ShopZen.Controllers
{
    public class UserTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,FirstName,LastName,Email,Password,CreatedAt")] UserTable userTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,FirstName,LastName,Email,Password,CreatedAt")] UserTable userTable)
        {
            if (ModelState.IsValid)
            {
